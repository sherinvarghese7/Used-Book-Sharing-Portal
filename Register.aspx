    ...
    <form  id="form1" runat="server">
      <!--  <div class="regmainpage wow fadeInDown">-->
        <div class="auto-style3 wow fadeInDown" style="border-radius: 15px;">
            ...
            &nbsp;&nbsp;<br />
            &nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_u_name" ErrorMessage="Field Required" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_name" ErrorMessage="Field Required" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_email" ErrorMessage="Field Required" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_mobno" ErrorMessage="Field Required" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_pwd" ErrorMessage=" Field Required" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_c_pwd" ErrorMessage=" Field Required" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_address" ErrorMessage=" Field Required" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
